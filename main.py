...
def returnStrDayList(startYear,startMonth,endYear,endMonth,day = "01"):
    ...
    for year in range(startYear,endYear+1):
        if year == startYear:#代表只需讀取starMonth之後的月份
...
startYear,startMonth = data["startYear"],data["startMonth"] #文字的格式
...
row = row + 1
#以下要透過yearList 抓取每一月份的資料
for month in yearList: #讀取年月日的資料
